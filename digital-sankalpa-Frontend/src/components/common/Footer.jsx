    ...
    <footer className="bg-white border-t">
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-bold mb-4">Digital Sankalpa</h3>
            <p className="text-gray-600 mb-4">
              Your one-stop shop for printers and accessories. Providing quality products since 2010.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products" className="text-gray-600 hover:text-blue-500">All Products</Link>
              </li>
              <li>
                <Link to="/sales" className="text-gray-600 hover:text-blue-500">Special Offers</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products?category=printers" className="text-gray-600 hover:text-blue-500">Printers</Link>
              </li>
              <li>
                <Link to="/products?category=scanners" className="text-gray-600 hover:text-blue-500">Scanners</Link>
              </li>
              <li>
                <Link to="/products?category=accessories" className="text-gray-600 hover:text-blue-500">Accessories</Link>
              </li>
              <li>
                <Link to="/products?category=ink" className="text-gray-600 hover:text-blue-500">Ink & Toner</Link>
              </li>
              <li>
                <Link to="/products?category=paper" className="text-gray-600 hover:text-blue-500">Paper & Media</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Email: info@digitalsankalpa.com
                </span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="md:flex md:justify-between md:items-center">
          <p className="text-sm text-gray-600 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Digital Sankalpa. All rights reserved.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <Link to="/shipping" className="text-sm text-gray-600 hover:text-blue-500">
              Shipping Policy
            </Link>
            <Link to="/return" className="text-sm text-gray-600 hover:text-blue-500">
              Return Policy
            </Link>
          </div>
        </div>
